...
public class TestBinario {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("****************************************");
        System.out.println("Inserto el 10 en raiz " + ((a.insertar(10, 1, true)) ? sOk : sErr));
        ...
        System.out.println("");
        System.out.println("Inserto el 9 como hijo I de 10: " + ((a.insertar(9, 10, true)) ? sOk : sErr));
        System.out.println("Busco el nivel de 9. Tiene que dar 1: " + sOk + " --> " + (((int) a.nivel(9) == 1) ? sOk : sErr));
        System.out.println("Inserto el 7 como hijo I de 9 " + ((a.insertar(7, 9, true)) ? sOk : sErr));
        System.out.println("Inserto el 3 como hijo D de 9 " + ((a.insertar(3, 9, false)) ? sOk : sErr));
        ...
        System.out.println("Inserto el 15 como hijo D de 10 " + ((a.insertar(15, 10, false)) ? sOk : sErr));
        System.out.println("Inserto el 12 como hijo I de 15 " + ((a.insertar(12, 15, true)) ? sOk : sErr));
        System.out.println("Inserto el 20 como hijo D de 15 " + ((a.insertar(20, 15, false)) ? sOk : sErr));
        ...
        System.out.println(a.modificarSubarboles(100, 1, 2));
        System.out.println(a.toString());
        System.out.println("\n");
        System.out.println("Inserto con padre inexistente. Tiene que dar: " + sErr + " --> " + ((a.insertar(5, 50, true)) ? sOk : sErr));        
        System.out.println("Inserto hijo I a raiz en pos llena. Tiene que dar: " + sErr + " --> " + ((a.insertar(5, 10, true)) ? sOk : sErr));
        System.out.println("Inserto hijo D a raiz en pos llena. Tiene que dar: " + sErr + " --> " + ((a.insertar(5, 10, true)) ? sOk : sErr));
        System.out.println("Inserto elemento duplicado en pos valida 10 como hijo I de 3. Tiene que dar " + sOk + " --> " + ((a.insertar(10, 3, false)) ? sOk : sErr));
        ...
        System.out.println("\n");
        System.out.println("Inserto el 25 como hijo D de 20 en CLON" + ((b.insertar(25, 20, true)) ? sOk : sErr));
        System.out.println("Inserto el 35 como hijo I de 20 en CLON" + ((b.insertar(35, 20, false)) ? sOk : sErr));
        System.out.println("\n" + AZUL + "CLON toString() \t\t\t");
        System.out.println("\n clon toString()  deberia dar: \n"
                + "            10 \n"
                + "        /       \\    \n"
        ...
        System.out.println("");
        System.out.println("Inserto el 40 como hijo D de 12 " + ((a.insertar(40, 12, true)) ? sOk : sErr));
        System.out.println("");
        ...
        System.out.println("");
        System.out.println("Inserto el 50 en el clon " + ((b.insertar(50, null, true)) ? sOk : sErr));
        System.out.println("");

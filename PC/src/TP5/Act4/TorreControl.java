...
class Aeropuerto{
    ...
    private int aterrizajesEsperando;
    private int despeguesEsperando;
    ...
    public Aeropuerto(int cantAvionesAterrizando){
        aterrizajesEsperando = 0;
        despeguesEsperando = 0;
        ...
        this.semTorre=new Semaphore(0);
        mutexControl = new Semaphore(1);
    ...
    public void autorizaciones(){
        try {
            ...
            else if(aterrizajesEsperando == 0 &&)
            {

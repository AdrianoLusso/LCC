...
public class OMSCaja {
    ...
    private Exchanger<Object> bufferCaja = new Exchanger<>();
    private int[] compra;
    ...
    public void cobrar()
    {
        ...
        try {
            dineroTotalDeHoy += (int) bufferCaja.exchange(compra);
    ...
    public int tomarTicket()
    {
        ...
        try {
            precio = (int) bufferCaja.exchange(null);
        } catch (InterruptedException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public void tomarCompra()
    {
        ...
        try {
            ...
            compra = (int[]) bufferCaja.exchange(1);
